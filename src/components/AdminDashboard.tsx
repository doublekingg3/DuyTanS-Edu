...
import { Users, UserX, Clock, TrendingUp, Calendar, BarChart2, BookOpen, CheckCircle, ChevronRight, ArrowUpDown, ArrowUp, ArrowDown } from 'lucide-react';
        ...
        <div className="xl:col-span-7 bg-white rounded-[20px] border border-teal-100 shadow-sm shadow-teal-500/5 overflow-hidden">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs sm:text-sm">
              <thead className="bg-[#0f766e] text-white uppercase text-[10px] sm:text-[11px] font-bold tracking-wider shadow-xs select-none">
                <tr>
                  <th 
