...
import { SchoolClass, Student, UserAccount, SchoolYear } from '../data';
import { Building2, Users, Search, Plus, Edit2, Trash2, Download, Upload, Shield, Key, Calendar, ArrowRight, Database, Save, Cloud, Server, Sparkles } from 'lucide-react';
import { useAlert } from "../contexts/AlertContext";
import { db } from '../lib/firebase';
import { doc, setDoc, deleteDoc, writeBatch, addDoc, collection } from 'firebase/firestore';
import { v4 as uuidv4 } from 'uuid';

export default function AdminView({ classes, students, users, schoolYears }: { classes: SchoolClass[], students: Student[], users: UserAccount[], schoolYears: SchoolYear[] }) {
