                ...
                <div className="col-span-2 space-y-4 border-t border-slate-100 pt-4 mt-2">
                  ...
                  <div className="bg-slate-50 p-4 rounded-xl space-y-4">
                    <label className="flex items-center gap-2 cursor-pointer">
                      ...
                      />
                      <span className="font-medium text-slate-700">Giáo viên Chủ nhiệm (GVCN)</span>
                    </label>
                  ...
                  <div className="bg-slate-50 p-4 rounded-xl space-y-4">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input 
                        ...
                        className="w-4 h-4 text-indigo-600 rounded border-slate-300 focus:ring-indigo-500"
                      />
                      <span className="font-medium text-slate-700">Giáo viên Bộ môn (GVBM)</span>
                    </label>
...
code = code.replace(
  /\s*<\/div>\n\s*\{userFormData.role === 'teacher' && \([\s\S]*?\}\)\s*\}\n\s*<\/div>/,
  newUI.trim() + '\n'
);

// Oh wait, I replaced the ending `</div>` of the grid. Let me fix the grid class to be full width or handle correctly.
// Let's use string replace on the specific blocks.
