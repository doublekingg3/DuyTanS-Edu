...
// regex to replace everything inside <div className="flex bg-white p-1 ... gap-1"> </div>
// since I already replaced the start, I will replace the buttons.
// Wait, I can just replace the whole block by extracting from `onClick={() => setActiveTab('classes')}` to the closing div.
